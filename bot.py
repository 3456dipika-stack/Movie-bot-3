...
PROMO_CHANNELS=[{"name":"@filestore4u","link":"https://t.me/filestore4u","id":-1002692055617},{"name":"@code_boost","link":"https://t.me/code_boost","id":-1002551875503},{"name":"@KRBOOK_official","link":"https://t.me/KRBOOK_official","id":-1002839913869}]
...
# --- FLASK APP ---
app=Flask(__name__)
# FIX: Flask decorator and function must be on separate lines
@app.route('/')
def home():return "Bot is alive and running!"
# --- UTILITY FUNCTIONS ---
@lru_cache(maxsize=1);def get_random_file_from_db_cached_sync():return None
